        ...
        fs.ensureDir(lambdaPackageDirectory)
            ...
            .then(() => {
                zip(lambdaPackageLocation, ['lambda_template/*'], err => {
                    ...
                    md5dir(userTemplateDirectory).then( (md5) => {
                        fs.writeFileSync(userTemplateHash,md5);
                        resolve();
                    });
                });
            }).catch(err => {
        ...
        isTemplateFolderCreated()
            ...
            .then( (hashExists) => {
              if(hashExists===false) {
                ...
                return Promise.all( [md5dir(userTemplateDirectory), fs.readFile(userTemplateHash, 'utf8')] );
              }
            })
            .then( (results) => {
